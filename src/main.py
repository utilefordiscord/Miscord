...
async def createRole(ctx, role):
  ...
  async def magic8ball(ctx):
    await ctx.send(random.choice([
      ...
      "Yes. :8ball:", "Signs point to yes. :8ball:", "Reply hazy, try again. :8ball:",
      "Ask again later. :8ball:", "Better not tell you now. :8ball:", "Cannot predict now. :8ball:",
      "Concentrate and ask again. :8ball:", "Don't count on it. :8ball:", "My reply is no. :8ball:",
      "My sources say no. :8ball:", "Outlook not so good. :8ball:", "Very doubtful. :8ball:"
    ]))
...
async def remove(ctx, *, number:int):
    ...
    deleted_title = bot.queue_titles[number-1]
